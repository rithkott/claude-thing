// Copied from nocturne-ui/vite.config.js (the canonical Chrome-69 kiosk
// config) minus the React plugin, plus base:'./' — the app lives at /claude/
// behind nocturned's ServeDir whose SPA fallback serves the ROOT index.html,
// so all routing is hash-based and all asset URLs relative.
