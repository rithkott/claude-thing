...
| r34 | 2026-08-02 | ghostty-tab-focus | Pressing a Ghostty session raises its own tab, matched by the ai-title Claude Code puts in the window title, and the dial can type into it |
