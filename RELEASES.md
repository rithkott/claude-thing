...
| 1.22.2 | 2026-08-04 | fix | daemon-link-liveness | DAEMON OFFLINE now reflects the link as it is: the device keeps checking — any claude.* frame counts, and a claude.ping asks after 40s of silence — instead of latching the banner on because the first request of the session was slow (#55) |
